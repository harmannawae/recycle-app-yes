...
export class SessionService {
  ...
  //public api = "http://localhost/recycle-api/";     // รันวงแลนเดี่ยวกัน
  public api = "https://recycle-app.000webhostapp.com/app/";     // ตัวแปรสำหรับชี้ที่ตั้งของ Api สำหรับในมหสลัย
  ...
  public Logout() {
    this.showConfirm("คุณแน่ใจต้องการออกจากระบบใช่หรือไม่ ?").then(async rs => {
      if (rs) {
        ...
        await this.removeStorage("user_order"); //ให้ลบข้อมูลคุกกี้ออกเมื่อเรากดออกจากระบบ
